...
select distinct apellido1, apellido2, nombre from persona where tipo = 'alumno' and strftime('%Y', fecha_nacimiento) = '1999' order by apellido1, apellido2, nombre desc;
/**
...
select nombre, apellido1||' '||apellido2 as apellidos from persona where telefono is null and ;
/**
